...
namespace Phan4_2
{
    public partial class FormLuong : Form
    {
        ...
        public void GetData()
        {
            var list = _context.luong.ToList();
        ...
        private void btnGhi_Click(object sender, EventArgs e)
        {
            if (Status == "Insert")
            {
                ...
                var exist = _context.luong.Find(Convert.ToInt32(txtID_L.Text));
            ...
            else
            {
                ...
                var a = _context.luong.Find(Convert.ToInt32(txtID_L.Text));
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            var find = _context.luong.Find(Convert.ToInt32(txtID_L.Text));

            try
            {
                _context.luong.Remove(find);
                _context.SaveChanges();
        ...
        private void btnTimKiem_Click(object sender, EventArgs e)
        {
            ...
            var list = _context.luong.Where(x => x.ID_Luong == ID_Luong);
            dataGridView1.AutoGenerateColumns = false;
