...
namespace Phan4_2
{
    public partial class FormPhongBan : Form
    {
        ...
        CtyModel _context = new CtyModel();
        public FormPhongBan()
        {
            InitializeComponent();
            this.LoadParent_ID();
        ...
        {
            var phongban = _context.phongban.ToArray();
        ...
        private void btnGhi_Click(object sender, EventArgs e)
        {
            if (Status == "Insert")
            {
                ...
                var exist = _context.phongban.Find(Convert.ToInt32(txtMaPB.Text));
            ...
            else
            {
                ...
                var a = _context.phongban.Find(Convert.ToInt32(txtMaPB.Text));
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            if (Result == DialogResult.No)
                return;
            var count = _context.phongban.Find(Convert.ToInt32(txtMaPB.Text)).nhansu.Count;
            ...
            var find = _context.phongban.Find(Convert.ToInt32(txtMaPB.Text));

            try
            {
                _context.phongban.Remove(find);
                _context.SaveChanges();
        ...
        private void btnTimKiem_Click(object sender, EventArgs e)
        {
            ...
            var list = _context.phongban.Where(x => x.MaPB == MaPB);
            dataGridView1.AutoGenerateColumns = false;
