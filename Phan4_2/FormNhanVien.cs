...
namespace Phan4_2
{
    public partial class FormNhanVien : Form
    {
        ...
        public void GetData()
        {
            var list = _context.nhansu.ToList();
        ...
        public void LoadHSL()
        {
            var luong = _context.luong.ToArray();
        ...
        private void btnGhi_Click(object sender, EventArgs e)
        {
            if (Status == "Insert")
            {
                ...
                var exist = _context.nhansu.Find(Convert.ToInt32(txtMaNS.Text));
            ...
            else
            {
                ...
                var a = _context.nhansu.Find(Convert.ToInt32(txtMaNS.Text));
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            if (Result == DialogResult.No)
                return;
            var find = _context.nhansu.Find(Convert.ToInt32(txtMaNS.Text));

            try
            {
                _context.nhansu.Remove(find);
                _context.SaveChanges();
        ...
        private void btnTimKiem_Click(object sender, EventArgs e)
        {
            ...
            var list = _context.nhansu.Where(x => x.MaNV == MaNV);
            dataGridView1.AutoGenerateColumns = false;
